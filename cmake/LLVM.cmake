if (NOT DEFINED LLVM_DIR AND NOT DEFINED ENV{LLVM_DIR})
    if (DEFINED LLVM_HOME)
        set(LLVM_DIR "${LLVM_HOME}/lib/cmake/llvm" CACHE PATH "Path to LLVM cmake config" FORCE)
    elseif (DEFINED ENV{LLVM_HOME})
        set(LLVM_DIR "$ENV{LLVM_HOME}/lib/cmake/llvm" CACHE PATH "Path to LLVM cmake config" FORCE)
    else ()
